...
export async function POST(request: Request) {
  try {
    ...
    if (!body.instrument || !['BUY','SELL'].includes(body.direction) || ![entry,stopLoss,takeProfit,riskPercent,initialRR].every(Number.isFinite)) {
