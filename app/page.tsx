...
const faqs = [
  ...
  ['What are the plan limits?', 'The current plan model is: Free = 15 analyses per anchored monthly cycle, Pro = 250, Elite = 1000, Team = unlimited. Exact plan capabilities and billing are enforced server-side.'],
];
...
export default async function LandingPage() {
  ...
  return <main className="marketing-page">
    <nav className="marketing-nav" aria-label="Public navigation"><Link className="marketing-brand" href="/" aria-label="Trade Police"><Image src="/brand/trade-police-logo.png" alt="Trade Police" width={232} height={48} className="brand-logo-wordmark" /></Link><div><a href="#how">How it works</a><Link href="/about">About</Link><Link href="/faq">FAQ</Link><Link href="/pricing">Pricing</Link><Link href="/legal">Legal</Link><Link className="button-link secondary marketing-cta" href="/client/login">Sign in</Link></div></nav>
    ...
    <section className="marketing-section pricing-preview"><p className="eyebrow">PRICING</p><h2>Start free. Upgrade for more capacity, not different rules.</h2><div className="marketing-actions"><Link className="button-link primary marketing-cta" href="/pricing">See plan limits</Link></div></section>
