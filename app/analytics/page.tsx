...
export default async function AnalyticsPage(){
 ...
 if(tradeResult.error){
  ...
  return <AuthenticatedAppShell eyebrow={c.eyebrow} displayName={displayName} description={c.description} userId={user.id}><section className="card error-state"><h1>{c.failed}</h1><p>{c.failedBody}</p></section></AuthenticatedAppShell>;
 }
