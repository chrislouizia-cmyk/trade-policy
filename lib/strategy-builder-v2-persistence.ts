...
export type StrategyBuilderV2State = { name:string; instruments:string[]; sessions:string[]; contextTimeframe?:string; executionTimeframe?:string; methodologyIds:string[]; ruleSelections:RuleSelection[]; ruleTree?:PersistedV2RuleTree; riskPercent:number; minimumRR:number; stopLogic?:StrategyBuilderV2StopLogic; targetLogic?:StrategyBuilderV2TargetLogic; direction?:StrategyBuilderV2Direction };
