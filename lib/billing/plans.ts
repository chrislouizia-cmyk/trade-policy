...
export const PLANS:Record<PlanCode,PlanDefinition>={
  FREE:{code:'FREE',name:'Free',monthlyAnalysisLimit:20,maximumActiveStrategies:1,canViewCompleteDecisionReport:false,canUseExpandedHistory:false,canUseExpandedAnalytics:false,checkoutEnabled:false},
