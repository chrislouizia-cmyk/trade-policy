...
export default function StrategyLearningConfirmation({profile,rules,onEdit,onConfirm}:{profile:StrategyProfile;rules:StrategyRule[];onEdit:()=>void;onConfirm:()=>void}){
  ...
  return <section className="card methodology-confirmation strategy-save-success strategy-complete-card" aria-labelledby="methodology-learned-title" aria-live="polite">
    <div className="methodology-confirmation-hero strategy-complete-hero"><span aria-hidden="true">✓</span><div><p className="muted">PLAYBOOK SAVED</p><h2 id="methodology-learned-title">Trade Police has learned your methodology.</h2><p>Your playbook is now translated into the evidence, risk, and confirmation sequence I’ll use for every analysis.</p></div></div>
