...
export default function HQHeader({displayName,role,permissions}:{displayName:string;role:string;permissions:string[]}) {
  ...
  return <header className="hq-shell-header">
    <div className="hq-brand-row">
      <a href="/hq" className="hq-brand"><Image src="/brand/trade-police-logo.png" alt="Trade Police" className="brand-logo-wordmark hq-logo-wordmark" width={200} height={42} priority/><span className="brand-caption hq-brand-caption"><small>Executive operations</small></span></a>
