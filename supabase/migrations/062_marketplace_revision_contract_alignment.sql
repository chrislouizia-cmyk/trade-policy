...
begin
  ...
  v_normalized := jsonb_strip_nulls(jsonb_build_object(
    ...
    'description', v_source_profile.description,
    'isDefault', v_source_profile.is_default,
    'isArchived', v_source_profile.is_archived,
    ...
    'greenDayProtectionEnabled', v_source_profile.green_day_protection_enabled,
    'greenDayProtectedFloorMode', v_source_profile.green_day_protected_floor_mode,
    ...
    'allowedSessions', to_jsonb(v_allowed_sessions),
    'sessions', v_sessions,
    ...
    'newsCurrencies', coalesce(v_source_profile.news_currencies, array['USD', 'GBP', 'JPY']),
    ...
    'strategyMethodologies', coalesce(v_source_profile.strategy_methodologies, array[]::text[]),
    'personalRules', coalesce(v_source_profile.personal_rules, array[]::text[]),
    'aiBehavior', case when v_source_profile.ai_behavior is null then null else v_source_profile.ai_behavior end
  ));
