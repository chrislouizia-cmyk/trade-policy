-- Production corrective migration for the V2 activation contract.
-- Canonical active_trades schema does not include strategy_version; the V2 function
-- must persist lifecycle metadata in the valid columns that exist in production.
