...
alter table public.active_trades add column if not exists strategy_version text;
alter table public.active_trades add column if not exists strategy_revision_id text;
