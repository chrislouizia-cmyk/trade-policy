-- Preserve one of eight minute credits for the display chart and the other
-- seven for an explicit customer decision. Background work may use at most
-- 80 of the Basic plan's 800 daily credits.
